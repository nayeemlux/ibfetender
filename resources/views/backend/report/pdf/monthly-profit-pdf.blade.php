...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            @php
            $student_fee=App\Model\AccountStudentFee::whereBetween('date',[$sdate,$edate])->where
            ('fee_category_id','1')->sum('amount');
            ...
            <i style="font-size: 10px; float: right">Profit Date:{{date("d M Y")}}</i>
        </div>
