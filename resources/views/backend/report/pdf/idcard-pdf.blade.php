...
<td width="30%" style="padding: 10px;">
    <img src="{{url('public/upload/logoctg.png')}}" style="width: 63px; height: 73px; border-radius: 5px;">
...
<td width="40%" class="text-center">
    ...
    <td width="30%" class="text-right" style="padding:10px;">
        <img src="{{(!empty($data['student']['image']))? url('public/upload/student_images/'.$data['student']['image']):url('upload/no_img.ping')}}" style="height: 73px; width: 63px; border-radius: 5px;">
