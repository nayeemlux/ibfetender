                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                        ...
                                        <a class="btn btn-success float-right btn-sm" href="{{route('suppliers.view')}}"><i class="fa fa-list"></i>Customer List</a>
                                    </h3>
                                ...
                                <form method="POST" action="{{route('customers.store')}}" id="myForm" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-row ">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="mobile_no"  class="form-control form-control-sm"id="mobile_no">
